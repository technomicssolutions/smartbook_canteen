...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.canteen'
        db.add_column(u'inventory_category', 'canteen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Canteen'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Category.canteen'
        db.delete_column(u'inventory_category', 'canteen_id')
