...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BatchItem.selling_price'
        db.add_column(u'inventory_batchitem', 'selling_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=50, decimal_places=5),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BatchItem.selling_price'
        db.delete_column(u'inventory_batchitem', 'selling_price')
