...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ClosingStockItem'
        db.delete_table(u'inventory_closingstockitem')

        # Deleting model 'ClosingStock'
        db.delete_table(u'inventory_closingstock')

        # Deleting model 'closingStockValue'
        db.delete_table(u'inventory_closingstockvalue')

        # Adding field 'BatchItem.closing_stock'
        db.add_column(u'inventory_batchitem', 'closing_stock',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BatchItem.consumed_quantity'
        db.add_column(u'inventory_batchitem', 'consumed_quantity',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

    def backwards(self, orm):
        # Adding model 'ClosingStockItem'
        db.create_table(u'inventory_closingstockitem', (
            ...
            ('consumed_quantity', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('closing_stock', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.ClosingStock'], null=True, blank=True)),
        ))
        db.send_create_signal(u'inventory', ['ClosingStockItem'])

        # Adding model 'ClosingStock'
        db.create_table(u'inventory_closingstock', (
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('canteen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Canteen'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'inventory', ['ClosingStock'])

        # Adding model 'closingStockValue'
        db.create_table(u'inventory_closingstockvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stock_by_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=5, blank=True)),
        ))
        db.send_create_signal(u'inventory', ['closingStockValue'])

        # Deleting field 'BatchItem.closing_stock'
        db.delete_column(u'inventory_batchitem', 'closing_stock')

        # Deleting field 'BatchItem.consumed_quantity'
        db.delete_column(u'inventory_batchitem', 'consumed_quantity')
