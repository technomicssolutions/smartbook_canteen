...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BatchItem.quantity_in_actual_unit'
        db.delete_column(u'inventory_batchitem', 'quantity_in_actual_unit')

        # Adding field 'BatchItem.stock'
        db.add_column(u'inventory_batchitem', 'stock',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'BatchItem.quantity_in_actual_unit'
        db.add_column(u'inventory_batchitem', 'quantity_in_actual_unit',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=100),
                      keep_default=False)

        # Deleting field 'BatchItem.stock'
        db.delete_column(u'inventory_batchitem', 'stock')
