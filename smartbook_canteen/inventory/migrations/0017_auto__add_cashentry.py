...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_cashentry', (
            ...
            ('cash', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=5, blank=True)),
        ))
        db.send_create_signal(u'inventory', ['cashEntry'])

    def backwards(self, orm):
        # Deleting model 'cashEntry'
        db.delete_table(u'inventory_cashentry')
    ...
    models = {
        ...
        u'inventory.cashentry': {
            ...
            'batch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Batch']", 'null': 'True', 'blank': 'True'}),
            'cash': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '5', 'blank': 'True'}),
