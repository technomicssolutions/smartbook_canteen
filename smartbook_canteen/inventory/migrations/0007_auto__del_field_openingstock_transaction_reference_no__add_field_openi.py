...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OpeningStock.transaction_reference_no'
        db.delete_column(u'inventory_openingstock', 'transaction_reference_no')

        # Adding field 'OpeningStock.canteen'
        db.add_column(u'inventory_openingstock', 'canteen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Canteen'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'OpeningStock.transaction_reference_no'
        db.add_column(u'inventory_openingstock', 'transaction_reference_no',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'OpeningStock.canteen'
        db.delete_column(u'inventory_openingstock', 'canteen_id')
