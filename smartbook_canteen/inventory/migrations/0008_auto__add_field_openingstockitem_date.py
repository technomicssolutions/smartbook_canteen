...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpeningStockItem.date'
        db.add_column(u'inventory_openingstockitem', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'OpeningStockItem.date'
        db.delete_column(u'inventory_openingstockitem', 'date')
