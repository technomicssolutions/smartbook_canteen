...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClosingStockItem.purchase_price'
        db.delete_column(u'inventory_closingstockitem', 'purchase_price')

        # Deleting field 'ClosingStockItem.net_amount'
        db.delete_column(u'inventory_closingstockitem', 'net_amount')

        # Deleting field 'ClosingStockItem.quantity'
        db.delete_column(u'inventory_closingstockitem', 'quantity')

        # Deleting field 'ClosingStockItem.uom'
        db.delete_column(u'inventory_closingstockitem', 'uom')

        # Adding field 'ClosingStockItem.canteen'
        db.add_column(u'inventory_closingstockitem', 'canteen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Canteen'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClosingStockItem.item'
        db.add_column(u'inventory_closingstockitem', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClosingStockItem.date'
        db.add_column(u'inventory_closingstockitem', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClosingStockItem.consumed_quantity'
        db.add_column(u'inventory_closingstockitem', 'consumed_quantity',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

        # Deleting field 'ClosingStock.transaction_reference_no'
        db.delete_column(u'inventory_closingstock', 'transaction_reference_no')

        # Adding field 'ClosingStock.canteen'
        db.add_column(u'inventory_closingstock', 'canteen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Canteen'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'ClosingStockItem.purchase_price'
        db.add_column(u'inventory_closingstockitem', 'purchase_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

        # Adding field 'ClosingStockItem.net_amount'
        db.add_column(u'inventory_closingstockitem', 'net_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

        # Adding field 'ClosingStockItem.quantity'
        db.add_column(u'inventory_closingstockitem', 'quantity',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

        # Adding field 'ClosingStockItem.uom'
        db.add_column(u'inventory_closingstockitem', 'uom',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ClosingStockItem.canteen'
        db.delete_column(u'inventory_closingstockitem', 'canteen_id')

        # Deleting field 'ClosingStockItem.item'
        db.delete_column(u'inventory_closingstockitem', 'item_id')

        # Deleting field 'ClosingStockItem.date'
        db.delete_column(u'inventory_closingstockitem', 'date')

        # Deleting field 'ClosingStockItem.consumed_quantity'
        db.delete_column(u'inventory_closingstockitem', 'consumed_quantity')

        # Adding field 'ClosingStock.transaction_reference_no'
        db.add_column(u'inventory_closingstock', 'transaction_reference_no',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ClosingStock.canteen'
        db.delete_column(u'inventory_closingstock', 'canteen_id')
