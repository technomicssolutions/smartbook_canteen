...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpeningStockItem.canteen'
        db.add_column(u'inventory_openingstockitem', 'canteen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Canteen'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OpeningStockItem.selling_price'
        db.add_column(u'inventory_openingstockitem', 'selling_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'OpeningStockItem.canteen'
        db.delete_column(u'inventory_openingstockitem', 'canteen_id')

        # Deleting field 'OpeningStockItem.selling_price'
        db.delete_column(u'inventory_openingstockitem', 'selling_price')
