...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Canteen'
        db.create_table(u'dashboard_canteen', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'dashboard', ['Canteen'])

    def backwards(self, orm):
        # Deleting model 'Canteen'
        db.delete_table(u'dashboard_canteen')
